...
**Senior Data Analyst | Product, Business & GenAI Analytics**
...
* Tableau dashboards for executives and product teams
* KPI frameworks, trend analysis, and benchmarking
* Translating insights into clear business narratives

### Automation & Scale

* Python for workflow automation and data processing
* SQL-based ETL and reporting pipelines
* Analysis of large-scale datasets (30M+ records)

### Advanced & GenAI Analytics

* LLM prompt engineering for insight extraction from reviews and feedback
* Qualitative-to-quantitative analysis of customer signals
...
* Automating reporting workflows, improving efficiency by ~60% and increasing decision velocity by ~40%
...
**Problem**
Investors required data-backed benchmarking to evaluate the competitive positioning of portfolio companies.
...
* 🔁 Supported initiatives contributing to **~20% reduction in customer churn**
* 🧠 Informed product improvement initiatives for **~60% of consumer brand clients**
* 🚀 Improved **decision velocity by ~40%** through automation and real-time dashboards
* 🤖 Reduced manual qualitative analysis by **50%+ using LLM-powered insight extraction**
...
* Defining metrics that matter, not just what is easy to measure
* Combining quantitative data with qualitative signals
* Using automation and GenAI responsibly to scale insights
* Communicating findings in a way that drives action

I aim to help teams move from **reactive reporting to proactive, insight-led decision-making**.
